...
const experiences = [
  {
    ...
    icon: starbucks,
    iconBg: "#383E56",
    date: "June 2024 - April 2024",
    points: [
      "Built a web app using the pygfx library that allows users to interact with real-time visualizations by offering a more interactive and dynamic experience",
